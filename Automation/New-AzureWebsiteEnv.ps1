<#
    ...
    sites. The default value is "Australia East". 
...
Param(
    ...
    [String]$Location = "Australia East",             # optional    default to "West US", needs to be a location which all the services created here are available
